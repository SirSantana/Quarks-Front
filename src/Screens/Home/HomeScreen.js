...
import { View, SafeAreaView, Text, Pressable, Image, Button, TouchableOpacity } from "react-native";
...
export const HomeScreen = () => {
  ...
  return (
    <SafeAreaView style={Theme.containers.containerParent}>
          ...
          <TouchableOpacity onPress={()=>navigation.navigate(user? 'Chat': 'Profile')}  style={[Theme.buttons.primary,{width:'90%'}]}>
